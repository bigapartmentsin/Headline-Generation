...
import com.sohu.headgen.model.components.GraphEncoder;
import com.sohu.headgen.model.components.GraphWeigher;
import com.sohu.headgen.model.components.PathCompressor;
 ...
 */
public final class HeadlineGenerator {

    private static final Logger logger = LoggerFactory.getLogger(HeadlineGenerator.class);
    ...
    private HeadlineGenerator(HeadlineGeneratorBuilder builder) {
    ...
    /**
     * Returns a {@code builder} for {@link HeadlineGenerator}.
     *
     * @return a {@code builder} for {@link HeadlineGenerator}
     */
    public static RequiresFolder builder() {
        return new HeadlineGeneratorBuilder();
    }
    ...
    public Optional<String> process(List<String> sentences, Collection<String> stopWords) {
        ...
        Optional<String> summary = compressor.compress(graph, PathCompressor.MAX_DEPTH);
        graph.shutdown();
    ...
    /**
     * An helper class to build a {@link HeadlineGenerator}.
     */
    ...
    public interface RequiresCompressor extends RequiresWeigher {
        HeadlineGeneratorBuilder withCompressor(PathCompressor compressor);
    }

    /**
     * An helper class to build a {@link HeadlineGenerator}.
     */
    public static class HeadlineGeneratorBuilder implements RequiresCompressor {
        ...
        private HeadlineGeneratorBuilder() {
        }
        ...
        @Override
        public HeadlineGeneratorBuilder withCompressor(PathCompressor compressor) {
            requireNonNull(compressor, "'compressor' is null");
            currentCompressor = compressor;
            return this;
        }

        public HeadlineGenerator build() {
            return new HeadlineGenerator(this);
        }
    }
}
