package com.sohu.headgen.model.components;
...
//            String[] tags = TAGGER.tag(tokens);
            ...
            for(Term term:terms) {
                String word = term.word.replaceAll(" ", "");
                wordsList.add(word);
                String tag = term.nature.toString();
                tagsList.add(tag);
            }
            String[] tokens = wordsList.toArray(new String[wordsList.size()]);
